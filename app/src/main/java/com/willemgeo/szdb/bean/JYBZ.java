...
@DatabaseTable(tableName = "tb_jybz")
public class JYBZ implements Serializable {
    ...
    String sfzh;
    @DatabaseField(columnName = "jdxx")
    String jdxx;
    @DatabaseField(columnName = "sxfy")
    double sxfy;
    @DatabaseField(columnName = "qtbz")
    double qtbz;
    ...
    public void setSxfy(double sxfy) {
        this.sxfy = sxfy;
    }

    public double getQtbz() {
        return qtbz;
    }
    public void setQtbz(double qtbz) {
        this.qtbz = qtbz;
    }
}
